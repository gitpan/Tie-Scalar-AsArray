...
Since I give you L<Tie::Scalar::AsHash>, it only makes sense that I do some
serious copy/paste and give you L<Tie::Scalar::AsArray>.
...
passed an appropriate C<$self> which will be a array reference. You'll also
...
L<Tie::Scalar::AsHash>, L<Tie::Scalar>, L<Tie::StdScalar>
...
C<bug-tie-scalar-asarray at rt.cpan.org>, or browse to
L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=Tie-Scalar-AsArray>.
...
L<http://annocpan.org/dist/Tie-Scalar-AsArray>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/Tie-Scalar-AsArray>

=item * RT: CPAN's request tracker

L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=Tie-Scalar-AsArray>

=item * Search CPAN

L<http://search.cpan.org/dist/Tie-Scalar-AsArray>
